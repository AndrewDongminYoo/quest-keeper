...
| ---------------- | -------------------------------------- | ----------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------- |
| Existing Tip Jar | Consumable                             | Voluntary support with no unlocked value                                                  | About sheet after value has already been experienced                   | Nothing to restore; user cancellation is silent; pending approval remains visible only while the current About sheet model remains alive                          | Core use remains offline; loading prices and purchasing require the App Store                                      | Retain unchanged                                      |
